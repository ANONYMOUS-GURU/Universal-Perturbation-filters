...
def preprocess_image_batch2(image_paths, img_size=(256, 256), crop_size=(224, 224), color_mode="rgb", out=None):
    i=0
    
    for img_name in os.listdir(image_paths):
        im_path=os.path.join(image_paths,img_name)
        img = imread(im_path, mode='RGB')
...
def preprocess_image_batch3(image_paths, img_size=(256, 256), crop_size=(224, 224), color_mode="rgb", out=None):
    i=0
    x=0
    for img_name in os.listdir(image_paths):
        im_path=os.path.join(image_paths,img_name)
